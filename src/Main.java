...
public class Main {
    ...
    private FileData Initialize() {
        ...
        for (Dimension dimension : Dimension.values()) {
            fileCommands.add(Execute.In(dimension) +
                    GameRuleCommand.set(GameRuleId.NATURAL_REGENERATION, false)
                                            .generate());
        }
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_IMMEDIATE_RESPAWN, true)
                        .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_PATROL_SPAWNING, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_MOB_SPAWNING, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_WEATHER_CYCLE, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.SPAWN_RADIUS, 0)
                .generate());
        ...
        fileCommands.add(GameModeCommand.ofDefault(GameModeId.ADVENTURE)
                .generate()
        );
    ...
    private FileData PlayerDeathHandler() {
        ...
        fileCommands.add(GameModeCommand.of(GameModeId.SPECTATOR,
                        Entity.ofSelector(
        ...
        fileCommands.add(Execute.Unless("@e[tag=" + TagTemp.RespawnDisabled + "]") +
                TagCommand.add(Entity.ofSelector(
                                TargetSelector.NEAREST_PLAYER,
                                SelectorArgumentsBuilder.create()
                                        .scores(Map.of(ScoreboardObjectiveId.DEATHS, 1))), EntityTag.RESPAWN)
                        .generate());
    ...
    private FileData ControlPointVisuals(int i) {
        ...
        for (Team team : teams) {
            ...
            fileCommands.add(Execute.If(Constant.adminOld, Objective.ColorCP.extendName(i), team.getID()) +
                    WaypointCommand.create(Entity.ofSelector(
    ...
    private FileData ClearEnderChest() {
        ...
        for (int i = 0; i < chestSize; i++) {
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                            ItemSlot.ENDERCHEST.withSlotNumber(i),
    ...
    private FileData EquipGear() {
        ...
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                        ItemSlot.CHEST,
                        ItemStack.create(DynamicItem.armor(ArmorMaterial.IRON, ArmorPiece.CHESTPLATE)))
                .generate());
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                        ItemSlot.FEET,
                        ItemStack.create(DynamicItem.armor(ArmorMaterial.IRON, ArmorPiece.BOOTS)))
                .generate());
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                        ItemSlot.HEAD,
                        ItemStack.create(DynamicItem.armor(ArmorMaterial.IRON, ArmorPiece.HELMET)))
                .generate());
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                        ItemSlot.LEGS,
                        ItemStack.create(DynamicItem.armor(ArmorMaterial.IRON, ArmorPiece.LEGGINGS)))
                .generate());
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                        ItemSlot.OFFHAND,
                        ItemStack.create(ItemId.SHIELD))
                .generate());
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                        ItemSlot.CHEST,
                        ItemStack.create(DynamicItem.tool(ToolMaterial.IRON, ToolPiece.AXE)))
                .generate());
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.ALL_PLAYERS),
                        ItemSlot.INVENTORY.withSlotNumber(0),
                        ItemStack.create(DynamicItem.tool(ToolMaterial.IRON, ToolPiece.SWORD)))
                .generate());
    ...
    private FileData GodMode() {
        ...
        fileCommands.add(EffectCommand.giveInfinite(Entity.ofSelector(TargetSelector.SENDER),
                        ...
                        true)
                .generate());
        fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                        ItemSlot.MAINHAND,
    ...
    private FileData GetStartPotions() {
        ...
        if (!OperationMode.teamCreationInGame) {
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                            ItemSlot.HOTBAR.withSlotNumber(0),
                            ItemStack.create(ItemId.SPLASH_POTION)
                    ...
                    .generate());
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                            ItemSlot.HOTBAR.withSlotNumber(1),
                            ItemStack.create(ItemId.SPLASH_POTION)
                            .with(PotionContentsComponent.create()
                                    .customColor("FF9933")
                                    .addEffect(PotionContentsComponent.CustomEffect.create(
                    ...
                    .generate());
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                            ItemSlot.HOTBAR.withSlotNumber(2),
                            ItemStack.create(ItemId.SPLASH_POTION)
                            .with(PotionContentsComponent.create()
                                    .customColor("6633CC")
                                    .addEffect(PotionContentsComponent.CustomEffect.create(
                    ...
                    .generate());
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                            ItemSlot.HOTBAR.withSlotNumber(3),
                            ItemStack.create(ItemId.SPLASH_POTION)
                            .with(PotionContentsComponent.create()
                                    .customColor("3399FF")
                                    .addEffect(PotionContentsComponent.CustomEffect.create(
                    ...
                    .generate());
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                            ItemSlot.HOTBAR.withSlotNumber(4),
                            ItemStack.create(ItemId.SPLASH_POTION)
                            .with(PotionContentsComponent.create()
                                    .customColor("00CC66")
                                    .addEffect(PotionContentsComponent.CustomEffect.create(
                    ...
                    .generate());
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                            ItemSlot.HOTBAR.withSlotNumber(5),
                            ItemStack.create(ItemId.SPLASH_POTION)
                            .with(PotionContentsComponent.create()
                                    .customColor("CC3333")
                                    .addEffect(PotionContentsComponent.CustomEffect.create(
                    ...
                    .generate());
            fileCommands.add(ItemCommand.replaceEntityWith(Entity.ofSelector(TargetSelector.SENDER),
                            ItemSlot.HOTBAR.withSlotNumber(6),
                            ItemStack.create(ItemId.SPLASH_POTION)
                            .with(PotionContentsComponent.create()
                                    .customColor("00FF7F")
                                    .addEffect(PotionContentsComponent.CustomEffect.create(
    ...
    private FileData DeveloperMode() {
        ...
        // Set gamerules
        fileCommands.add(GameRuleCommand.set(GameRuleId.COMMAND_BLOCK_OUTPUT, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_DAYLIGHT_CYCLE, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.KEEP_INVENTORY, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_MOB_SPAWNING, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_TILE_DROPS, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DROWNING_DAMAGE, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.FALL_DAMAGE, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.FIRE_DAMAGE, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.SEND_COMMAND_FEEDBACK, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_IMMEDIATE_RESPAWN, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DISABLE_RAIDS, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_INSOMNIA, false)
                .generate());
        ...
        for (int i = 0; i < 4; i++) {
            fileCommands.add(Execute.As("@a", false) +
                    ...
                    DataCommand.get(Entity.ofSelector(TargetSelector.SENDER),
        ...
        // Remove tags
        fileCommands.add(TagCommand.remove(Entity.ofSelector(TargetSelector.ALL_PLAYERS), EntityTag.RESPAWN_DISABLED)
                .generate());
        fileCommands.add(TagCommand.remove(Entity.ofSelector(TargetSelector.ALL_PLAYERS), EntityTag.IRON_MAN_CANDIDATE)
                .generate());
        fileCommands.add(TagCommand.remove(Entity.ofSelector(TargetSelector.ALL_PLAYERS), EntityTag.IRON_MAN)
                .generate());
        fileCommands.add(TagCommand.remove(Entity.ofSelector(TargetSelector.ALL_PLAYERS), EntityTag.RESPAWN)
                .generate());
        fileCommands.add(TagCommand.remove(Constant.admin, EntityTag.GAME_STARTED)
                .generate());
        ...
        fileCommands.add(GameModeCommand.of(GameModeId.CREATIVE,
                        Entity.ofSelector(TargetSelector.SENDER))
                .generate());
        ...
        if (OperationMode.carePackages) {
            ...
            // Remove tags
            fileCommands.add(TagCommand.remove(Constant.admin, EntityTag.CARE_PACKAGES_DROPPED)
                    .generate());
        }
        ...
        if (OperationMode.controlPoints) {
            ...
            // Remove tags
            fileCommands.add(TagCommand.remove(Constant.admin, EntityTag.indexed(EntityTag.CONTROL_POINT_ENABLED, 1))
                    .generate());
            fileCommands.add(TagCommand.remove(Constant.admin, EntityTag.indexed(EntityTag.CONTROL_POINT_ENABLED, 2))
                    .generate());
            fileCommands.add(TagCommand.remove(Constant.admin, EntityTag.CONTROL_POINT_CAPTURED)
                    .generate());
        ...
        if (OperationMode.traitorFaction) {
            ...
            // Remove tags
            fileCommands.add(TagCommand.remove(Entity.ofSelector(TargetSelector.ALL_PLAYERS), EntityTag.TRAITOR)
                    .generate());
            fileCommands.add(TagCommand.remove(Entity.ofSelector(TargetSelector.ALL_PLAYERS), EntityTag.DONT_MAKE_TRAITOR)
                    .generate());
            fileCommands.add(TagCommand.remove(Constant.admin, EntityTag.TRAITORS_ASSIGNED)
                    .generate());
        }
    ...
    private FileData Predictions() {
        ...
        // Make players fall
        fileCommands.add(TagCommand.add(Entity.ofSelector(
                TargetSelector.ALL_PLAYERS,
                SelectorArgumentsBuilder.create()
                        .gamemode(GameModeId.ADVENTURE, true)), EntityTag.IS_FLYING)
                        .generate());

        fileCommands.add(GameModeCommand.of(GameModeId.ADVENTURE,
                        Entity.ofSelector(
                                TargetSelector.ALL_PLAYERS,
                                SelectorArgumentsBuilder.create()
        ...
        fileCommands.add(GameModeCommand.of(GameModeId.CREATIVE,
                        Entity.ofSelector(
                                ...
                                SelectorArgumentsBuilder.create()
                                        .tag(EntityTag.IS_FLYING)))
                .generate());
        fileCommands.add(TagCommand.remove(Entity.ofSelector(
                                TargetSelector.ALL_PLAYERS,
                                SelectorArgumentsBuilder.create()
                                        .tag(EntityTag.IS_FLYING)), EntityTag.IS_FLYING)
                .generate());
        ...
        if (!OperationMode.teamCreationInGame) {
            for (Team t : teams) {
                ...
                fileCommands.add(Execute.If("@p[team=" + t.getName() + ",scores={Deaths=0}]", false) +
                        ...
                        TagCommand.add(Constant.admin, EntityTag.PREDICTIONS_COMPLETED)
                                .generate());
            ...
            fileCommands.add(TagCommand.add(Entity.ofSelector(
                    ...
                    SelectorArgumentsBuilder.create()
                            .team(true)
                            .scores(Map.of(ScoreboardObjectiveId.DEATHS, 0))), EntityTag.PREDICTION_CANDIDATE)
                            .generate());
            ...
            fileCommands.add(TagCommand.remove(Entity.ofSelector(
                                    TargetSelector.NEAREST_PLAYER,
                                    SelectorArgumentsBuilder.create()
                                            .tag(EntityTag.PREDICTION_CANDIDATE)), EntityTag.PREDICTION_CANDIDATE)
                    .generate());
        }
    ...
    private FileData SurvivalMode() {
        ArrayList<String> fileCommands = new ArrayList<>();
        fileCommands.add(GameRuleCommand.set(GameRuleId.COMMAND_BLOCK_OUTPUT, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_DAYLIGHT_CYCLE, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.KEEP_INVENTORY, false)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_MOB_SPAWNING, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_TILE_DROPS, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DROWNING_DAMAGE, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.FALL_DAMAGE, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.FIRE_DAMAGE, true)
                .generate());
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_IMMEDIATE_RESPAWN, true)
                .generate());
    ...
    private FileData StartGame() {
        ...
        fileCommands.add(GameModeCommand.of(GameModeId.SURVIVAL,
                        Entity.ofSelector(TargetSelector.ALL_PLAYERS))
                .generate());
    ...
    private FileData BattleRoyale() {
        ...
        fileCommands.add(Execute.In(Dimension.overworld, false) +
                ...
                GameModeCommand.of(GameModeId.SURVIVAL,
                                Entity.ofSelector(
                                        TargetSelector.ALL_PLAYERS,
                                        SelectorArgumentsBuilder.create()
                                                .distance("..20")
    ...
    private FileData InitializeControlPoint() {
        ...
        fileCommands.add(TagCommand.add(Constant.admin, EntityTag.indexed(EntityTag.CONTROL_POINT_ENABLED, 1))
                .generate());
    ...
    private FileData SecondControlPoint() {
        ...
        // Give admin tag for disabling self-rescheduling
        fileCommands.add(TagCommand.add(Constant.admin, EntityTag.indexed(EntityTag.CONTROL_POINT_ENABLED, 2))
                .generate());
    ...
    private FileData DropCarepackages() {
        ...
        // Give admin tag for disabling self-rescheduling
        fileCommands.add(TagCommand.add(Constant.admin, EntityTag.CARE_PACKAGES_DROPPED)
                .generate());
    ...
    private FileData TraitorHandout() {
        ...
        if (traitorWaitTime > 0) {
            ...
            for (Player p : players) {
                if (p.getLastTraitorSeason() >= seasons.get(seasons.size() - traitorWaitTime).getID()) {
                    ...
                    fileCommands.add(TagCommand.add(Entity.ofName(p.getPlayerName()), EntityTag.DONT_MAKE_TRAITOR)
                                            .generate());
                }
            }
        }
        ...
        fileCommands.add(TagCommand.add(Entity.ofSelector(
                ...
                SelectorArgumentsBuilder.create()
                        ...
                        .gamemode(GameModeId.SPECTATOR, true)), EntityTag.TRAITOR)
                        .generate());
        ...
        for (Team t : teams) {
            fileCommands.add(Execute.If("@p[tag=" + TagTemp.Traitor + ",team=" + t.getName() + "]") +
                    TagCommand.add(Entity.ofSelector(
                                            TargetSelector.ALL_PLAYERS,
                                            SelectorArgumentsBuilder.create()
                                                    .team(t.getName())), EntityTag.DONT_MAKE_TRAITOR)
                            .generate());
        }
        ...
        fileCommands.add(TagCommand.add(Entity.ofSelector(
                ...
                SelectorArgumentsBuilder.create()
                        ...
                        .team(true)), EntityTag.DONT_MAKE_TRAITOR)
                        .generate());
        ...
        if (traitorMode == 2) {
            ...
            fileCommands.add(TagCommand.add(Entity.ofSelector(
                            TargetSelector.ALL_PLAYERS,
                            SelectorArgumentsBuilder.create()
                                    .tag(EntityTag.TRAITOR)), EntityTag.DONT_MAKE_TRAITOR)
                    .generate());
            fileCommands.add(TagCommand.add(Entity.ofSelector(
                            TargetSelector.RANDOM_PLAYER,
                            SelectorArgumentsBuilder.create()
        ...
        // Give admin tag for disabling self-rescheduling
        fileCommands.add(TagCommand.add(Constant.admin, EntityTag.TRAITORS_ASSIGNED)
                                .generate());
    ...
    private FileData RemoveBannedItems() {
        ...
        Entity target = Entity.ofSelector(
                TargetSelector.NEAREST_PLAYER,
                SelectorArgumentsBuilder.create()
        ...
        fileCommands.add(ItemCommand.replaceEntityWith(target, ItemSlot.MAINHAND, replacement)
                .generate());
    ...
    private FileData RespawnPlayer() {
        ...
        // Remove respawn tag
        fileCommands.add(TagCommand.remove(respawnPlayer, EntityTag.RESPAWN)
                        .generate());
    ...
    private FileData ControlPointCaptured() {
        ...
        // Give admin tag for disabling self-rescheduling
        fileCommands.add(TagCommand.add(Constant.admin, EntityTag.CONTROL_POINT_CAPTURED)
                                .generate());
    ...
    private FileData TeamsAliveCheck() {
        ...
        if (OperationMode.teamCreationInGame) {
            ...
            fileCommands.add(TagCommand.add(Entity.ofSelector(
                    ...
                    SelectorArgumentsBuilder.create()
                            .team(true)
                            .gamemode(GameModeId.SPECTATOR, true)), EntityTag.AM_I_WINNING)
                            .generate());
            ...
            fileCommands.add(TagCommand.remove(Entity.ofSelector(
                                    TargetSelector.NEAREST_PLAYER,
                                    SelectorArgumentsBuilder.create()
                                            .tag(EntityTag.AM_I_WINNING)), EntityTag.AM_I_WINNING)
                    .generate());
        }
    ...
    private FileData WolfUpdates() {
        ...
        for (Team t : teams) {
            fileCommands.add(Execute.As("@e[type=" + EntityId.WOLF + "]", false) +
                    ...
                    DataCommand.setEntityValue(Entity.ofSelector(TargetSelector.SENDER),
                                    DataPath.create(DataPathId.COLLAR_COLOR),
                                    DataValue.createByte((byte) t.getCollarColor()))
                            .generate());
        }
        ...
        if (OperationMode.teamCreationInGame) {
            ...
            fileCommands.add(TagCommand.add(Entity.ofSelector(
                    TargetSelector.ALL_PLAYERS,
                    SelectorArgumentsBuilder.create()
                            .team(true)), EntityTag.COLLAR_CHECK)
                            .generate());
            fileCommands.add(Execute.As("@e[type=" + EntityId.WOLF + "]", false) +
    ...
    private FileData DisableRespawn() {
        ...
        // Add first blood tag
        fileCommands.add(TagCommand.add(Constant.admin, EntityTag.RESPAWN_DISABLED)
                                .generate());

        // Update immediate respawn
        fileCommands.add(GameRuleCommand.set(GameRuleId.DO_IMMEDIATE_RESPAWN, false)
                .generate());
    ...
    private FileData UpdatePlayerDistance() {
        ...
        fileCommands.add(TagCommand.add(checkingPlayer, EntityTag.LOOKING_FOR_TEAM_MATE)
                                .generate());
        ...
        fileCommands.add(TagCommand.remove(Entity.ofSelector(
                                TargetSelector.NEAREST_PLAYER,
                                SelectorArgumentsBuilder.create()
                                        .scores(Map.of(ScoreboardObjectiveId.TIMES_CALLED, "1.."))), EntityTag.LOOKING_FOR_TEAM_MATE)
                .generate());
    ...
    private FileData CheckIronMan() {
        ...
        fileCommands.add(TagCommand.add(Entity.ofSelector(
                                TargetSelector.RANDOM_PLAYER,
                                SelectorArgumentsBuilder.create()
                                        .scores(Map.of(ScoreboardObjectiveId.DAMAGE_TAKEN, ".." + minDamage))), EntityTag.IRON_MAN_CANDIDATE)
                .generate());
        ...
        fileCommands.add(TagCommand.remove(Entity.ofSelector(
                                TargetSelector.NEAREST_PLAYER,
                                SelectorArgumentsBuilder.create()
                                        .tag(EntityTag.IRON_MAN_CANDIDATE)), EntityTag.IRON_MAN_CANDIDATE)
                .generate());
    ...
    private FileData AnnounceIronMan() {
        ...
        fileCommands.add(TagCommand.add(Entity.ofSelector(TargetSelector.SENDER), EntityTag.IRON_MAN)
                .generate());
    ...
    private FileData DebugGive() {
        ...
        fileCommands.add(TagCommand.add(Entity.ofSelector(TargetSelector.SENDER), EntityTag.DEBUG)
                .generate());
    ...
    private FileData DebugRemove() {
        ...
        fileCommands.add(TagCommand.remove(Entity.ofSelector(TargetSelector.SENDER), EntityTag.DEBUG)
                .generate());
