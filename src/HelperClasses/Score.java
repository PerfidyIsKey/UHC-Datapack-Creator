...
public class Score extends TextItem {
    ...
    public Score(TextColor color, boolean isBold, boolean isItalic, String name, String objective) {
    ...
    public Score(TextColor color, boolean isBold, boolean isItalic, String name, Objective objective) {
        super(color, isBold, isItalic);
        this.name = name;
