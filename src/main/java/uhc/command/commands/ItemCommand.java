...
import uhc.command.util.ItemSlot; // Note: Used for sourceSlot argument in replaceFrom
import uhc.command.util.SpecificItemSlot; // Note: Used for targetSlot argument
