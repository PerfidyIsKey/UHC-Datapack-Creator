...
import uhc.arguments.item.slot.ItemSlot; // Note: Used for sourceSlot argument in replaceFrom
import uhc.arguments.item.slot.SpecificItemSlot; // Note: Used for targetSlot argument
