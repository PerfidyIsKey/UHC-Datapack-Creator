execute positioned -30 86 -57 run effect give @p[gamemode=!spectator] minecraft:speed 20 1
execute positioned 124 63 214 run effect give @p[gamemode=!spectator] minecraft:speed 20 1
