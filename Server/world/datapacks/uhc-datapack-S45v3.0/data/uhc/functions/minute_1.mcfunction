tellraw @a ["",{"text":" ⎜ ","color":"gray"},{"text":"THE DIORITE EXPERTS UHC","color":"gold"},{"text":" ⎜ ","color":"gray"},{"text":" 1 minute(s) remaining.","color":"light_purple"},{"text":" ⎜ ","color":"gray"}]
title @a title {"text":"1 minute(s) remaining.", "bold":true, "italic":true, "color":"gold"}
