execute positioned -30 86 -57 run effect give @p[gamemode=!spectator] minecraft:nausea 10 1
execute positioned 124 63 214 run effect give @p[gamemode=!spectator] minecraft:nausea 10 1
