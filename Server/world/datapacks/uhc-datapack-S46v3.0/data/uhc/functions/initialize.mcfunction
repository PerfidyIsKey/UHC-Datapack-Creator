...
setblock 0 222 -5 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Color:"black",GlowingText:0b,Text1:'{"clickEvent":{"action":"run_command","value":"tp @s 5 -59 5"},"text":""}',Text2:'{"text":"Teleport to"}',Text3:'{"text":"Command Center"}',Text4:'{"text":""}'}
setblock -2 -64 -2 minecraft:structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"?",rotation:"NONE",posX:1,mode:"LOAD",posY:1,sizeX:18,posZ:1,integrity:1.0f,showair:0b,name:"minecraft:commandcenter_s46",sizeY:31,sizeZ:18,showboundingbox:1b}
